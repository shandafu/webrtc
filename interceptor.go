...
func RegisterDefaultInterceptors(mediaEngine *MediaEngine, interceptorRegistry *interceptor.Registry, pli *int) error {
	if err := ConfigureNack(mediaEngine, interceptorRegistry, pli); err != nil {
		return err
	}
...
func ConfigureNack(mediaEngine *MediaEngine, interceptorRegistry *interceptor.Registry, pli *int) error {
	generator, err := nack.NewGeneratorInterceptor()
	if err != nil {
		return err
	}

	responder, err := nack.NewResponderInterceptor(pli)
	if err != nil {
		return err
	}
